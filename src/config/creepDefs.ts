...
export const WORKER_PARTS: PartDefinition = {
  ...
  1800: [MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY],
  2250: [MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY]
};
...
export const UPGRADER_PARTS: PartDefinition = {
  ...
  1300: [MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, WORK, WORK, WORK, WORK],
  1550: [MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, WORK, WORK, WORK, WORK],
  1800: [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK,
    WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY],
  2250: [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, WORK, WORK, WORK,
    WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY,
...
export const HAULER_PARTS: PartDefinition = {
  ...
  2250: [MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY]
};
...
export const MINER_PARTS: PartDefinition = {
  ...
  1800: [MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, WORK, CARRY],
  2250: [MOVE, MOVE, MOVE, WORK, WORK, WORK, WORK, WORK, CARRY]
}
...
export const HEALER_PARTS: PartDefinition = {
  ...
  2250: [TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH, TOUGH,
...
export const ATTACKER_PARTS: PartDefinition = {
  ...
  2250: [TOUGH, TOUGH, TOUGH, TOUGH, MOVE, MOVE, ATTACK, ATTACK, MOVE, MOVE, ATTACK, ATTACK, MOVE, MOVE, ATTACK, ATTACK]
}
...
export const CLAIMER_PARTS: PartDefinition = {
  ...
  2250: [MOVE, MOVE, MOVE, MOVE, CLAIM, CLAIM]
}

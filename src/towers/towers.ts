...
export class SearchHostilesNode extends b3.BaseNode implements b3.BaseNode {
  constructor() {
    super();
...
export class FilterOutAlliesNode extends b3.BaseNode implements b3.BaseNode {
  constructor() {
    super();
...
export class SelectTargetNode extends b3.BaseNode implements b3.BaseNode {
  constructor() {
    super();
...
export class AttackTargetNode extends b3.BaseNode implements b3.BaseNode {
  constructor() {
    super();
